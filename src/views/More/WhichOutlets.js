...
const WhichOutletsScreen = () => {
  const ItemMenu = ({column1, column2, column3 = {}}) => (
    <View style={[styles.itemMenuRow, styles.paddingLine]}>
      ...
      <View style={styles.itemColumn}>
        ...
        {!!column3.title && (
          <Text style={[styles.titleItemMenu, styles.paddingLine]}>
            {column3.title}
          </Text>
        )}
        {!!column3.title && (
          <Text style={styles.contentItemMenu}>{column3.content}</Text>
        )}
      </View>
    </View>
  );
  ...
  const ItemList = ({content, isPaddingTop}) => (
    <View style={[styles.flexRow, isPaddingTop && styles.paddingLine]}>
      ...
      <Text style={styles.contentOutlet}>{content}</Text>
    </View>
  );
      ...
      <ScrollView>
        <View style={styles.bodyWhichOutlets}>
          ...
          <Text style={[styles.content, styles.paddingLine]}>
            Smaller chains and supermarkets with fewer outlets are not included,
            but may volunteer to display the information for their customers.
            Single outlet businesses are also not included.
          </Text>
          <Text style={[styles.content, styles.paddingLine]}>
          ...
          />
          <Text style={[styles.content, styles.paddingLine]}>
            This list will change from time to time and may not be current. We
            regularly review the list.
          </Text>
          <Text style={[styles.subTitle, styles.paddingLine]}>Exemptions</Text>
          <Text style={[styles.content, styles.paddingLine]}>
            Even if they meet the other criteria, some chains of food outlets
          ...
          <Text style={[styles.content, styles.paddingLine]}>
            As of 13 February 2013, Coles, Woolworths and IGA Supermarkets will
            carry kJ values, as well as for ready-to-eat foods like hot
